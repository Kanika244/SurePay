...
import { CouponTemplate, couponCategoryLabels, merchantCategoryLabels } from "@/data/couponMockData";
...
const CouponTemplates = () => {
  ...
  return (
    <EnterpriseLayout title="Coupon Templates" subtitle="Create and manage reusable coupon definitions">
      <div className="flex flex-wrap items-center gap-3 mb-6">
        <Link to="/enterprise/coupons/templates/create">
          <Button className="gap-2"><Plus size={16} /> Create Template</Button>
        </Link>
