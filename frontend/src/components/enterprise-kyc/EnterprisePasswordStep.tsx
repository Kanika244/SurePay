...
interface EnterprisePasswordStepProps {
    password: string;
        ...
        >
            <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                    Create a strong password for your enterprise account
                </p>
            </div>
...
export default EnterprisePasswordStep;
