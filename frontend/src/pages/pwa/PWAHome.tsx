...
import { Send, ArrowDownLeft, QrCode, Ticket } from "lucide-react";
import CouponWidget from "@/components/pwa/CouponWidget";
...
const quickActions = [
  ...
  { to: "/app/coupons", icon: Ticket, label: "Coupons", color: "bg-secondary/10 text-secondary" },
];
